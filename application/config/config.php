...
define('PAGEADMIN_URL','http://192.168.0.58/waycooldemo/');
  ...
  $config['base_url'] = 'http://'.$_SERVER['SERVER_NAME'].'/'; // Base URL including trailing slash (e.g. http://192.168.0.47/)
  $config['default_controller'] = 'main'; // Default controller to load
  $config['error_controller'] = 'page_error'; // Controller used for errors (e.g. 404, 500 etc)
  define('img_base_url','http://'.$_SERVER['SERVER_NAME'].'/'); // Base URL including trailing slash (e.g. http://192.168.0.47/)
  
  define('PAGEADMIN_URL','http://'.$_SERVER['SERVER_NAME'].'/');
  define('MAILLOGO','http://'.$_SERVER['SERVER_NAME'].'/uploads/logo/');
  define('resumeurl','http://'.$_SERVER['SERVER_NAME'].'/uploads/resume/');
}
