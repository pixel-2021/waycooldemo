...
mail(TOEMAIL, $subject, $message, $headers);
 ...
 function getEproductcat($db){ 	
     ...
     $strQry =" select * from ".tbl_category."  where IsActive=1 and parentid=0 and cattype=1 order by sortorder"; 
	 $resulst=$db->get_rsltset($strQry);	
 	 return $resulst;
 } 
 ...
 function getEproductcatprod($db,$ctid){ 	
    ...
    p.categoryid = c.categoryID and c.IsActive = 1 and c.cattype=1 and p.IsActive = 1 and p.producttype=1 AND c.categoryslug = '".$ctid."' order by p.mydate desc";
	//echo $strQry;		exit;
	 $resulst=$db->get_rsltset($strQry);
 	 return $resulst;
 } 
 ...
 function getEproductdetailname($db,$ptid){ 	
	 ...
	 $strQry =" select c.* from ".tbl_product." p INNER JOIN ".tbl_category." c where p.categoryid = c.categoryID and c.IsActive=1 and c.cattype=1 and p.producttype=1 and productslug ='".$ptid."'";
	 $resulst=$db->get_a_line($strQry);
	 return $resulst;
 }
 ...
 function getEproductdetailspec($db,$ptid){ 	
	 ...
	 $strQry = "SELECT ps.*, p.* FROM ".tbl_product_specification." ps INNER JOIN ".tbl_product." p WHERE ps.IsActive = 1 AND p.IsActive = 1 and p.producttype=1 and p.productID = ps.productID AND productslug = '".$ptid."' order by ps.sorting_order ";
	 $resulst=$db->get_rsltset($strQry);
	 return $resulst;
 }
 ...
 function getEproductdetaildwld2($db,$ptid){ 	
	 ...
	 $strQry = "SELECT pd.*, p.* FROM ".tbl_product_downloads." pd INNER JOIN ".tbl_product." p WHERE pd.manuals_id = '2' and pd.IsActive = 1 AND p.IsActive = 1  and producttype=1 and p.productID = pd.productID AND productslug = '".$ptid."' order by pd.sorting_order";
	 $resulst=$db->get_rsltset($strQry);
	 return $resulst;
 }
 ...
 function getRproductcat($db){ 	
     ...
     $strQry =" select * from ".tbl_rcategory."  where IsActive=1 and parentid=0 order by sortorder"; 
	 $resulst=$db->get_rsltset($strQry);	
 	 return $resulst;
 }
 ...
 function getRproductcatprod($db,$ctid){ 
	//echo $ctid;		exit;
     $strQry =" SELECT p.* FROM ".tbl_rproduct." p INNER JOIN ".tbl_rcategory." c WHERE
    p.categoryid = c.categoryID and c.IsActive = 1 and p.IsActive = 1 AND c.categoryslug = '".$ctid."' order by p.mydate desc";
	//echo $strQry;		exit;
	 $resulst=$db->get_rsltset($strQry);
	 //print_r($resulst);		exit;
 	 return $resulst;
 ...
 function getEproductdetaildesc($db,$ptid){ 	
	 ...
	 $strQry = "SELECT ps.*, p.*, ps.description as proddesc FROM ".tbl_product_description." ps INNER JOIN ".tbl_product." p WHERE ps.IsActive = 1 AND p.IsActive = 1 and p.producttype=1 and p.productID = ps.productID AND productslug = '".$ptid."' order by ps.sorting_order ";
	 //echo $strQry;	exit;
	 $resulst=$db->get_rsltset($strQry);
	 //print_r($resulst);		exit;
	 return $resulst;
 ...
 */
 ...
 // For Automation solutions Method 
  function getAproductcat($db){ 	
     ...
     $strQry =" select * from ".tbl_category."  where IsActive=1 and parentid=0 and cattype=2 order by sortorder"; 
	 $resulst=$db->get_rsltset($strQry);	
 	 return $resulst;
 } 
 ...
 function getAproductsubcat($db,$ctid){ 	
	 ...
	 $strQry = "select * from ".tbl_product." where IsActive=1 and producttype=2 and (categoryid = (select categoryID from ".tbl_category." where categoryslug = '".$ctid."') or subcategoryid = (select categoryID from ".tbl_category." where categoryslug = '".$ctid."')) order by ".tbl_product.".mydate desc";
	 //echo $strQry;		exit;
	 $resulst=$db->get_rsltset($strQry);
 	 return $resulst;
 } 
 ...
 //Automation Solution details function
	...
	function getAproductdetaildwld2($db,$ptid){ 	
	 ...
	 $strQry = "SELECT pd.*, p.* FROM ".tbl_product_downloads." pd INNER JOIN ".tbl_product." p WHERE pd.manuals_id = '2' and pd.IsActive = 1 AND p.IsActive = 1  and producttype=2 and p.productID = pd.productID AND productslug = '".$ptid."' order by pd.sorting_order";
	 $resulst=$db->get_rsltset($strQry);
	 return $resulst;
    }
